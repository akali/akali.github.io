...
//            window.localStorage[key] = defaultValue;
    ...
    this.initializePubSub = function () {
        ...
        if (that.pushstream == null && window.codeforcesOptions.subscribeServerUrl) {
            ...
            if (window.codeforcesOptions.standaloneGroupDomain) {
                var standaloneGroupDomain = '.' + window.codeforcesOptions.standaloneGroupDomain;
                if (window.location.host.indexOf(standaloneGroupDomain, this.length - standaloneGroupDomain.length) !== -1) {
                    host = undefined;
                }
            }
